...
namespace API.Data.Migrations
{
    ...
    [Migration("20240505212824_SpesimentRename")]
    partial class SpesimentRename
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.Spesiment", b =>
                {
                    b.Property<int>("SpesimentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SpesimentId"));
                    ...
                    b.Property<DateTime>("SpesimentDate")
                        .HasColumnType("datetime2");

                    b.HasKey("SpesimentId");

                    b.HasIndex("CreatedById");

                    b.HasIndex("PointId");

                    b.ToTable("Spesiments");
                });

            modelBuilder.Entity("API.Entities.SpesimentItem", b =>
                {
                    b.Property<int>("SIId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SpesimentId");

                    b.HasIndex("UnitBaseId");

                    b.HasIndex("UnitId");

                    b.ToTable("SpesimentItems");
                });
            ...
            modelBuilder.Entity("API.Entities.SpesimentItem", b =>
                {
                    b.HasOne("API.Entities.Item", "Item")
                        .WithMany("SpesimentItems")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.Spesiment", "Spesiment")
                        .WithMany("SpesimentItems")
                        .HasForeignKey("SpesimentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.Unit", "UnitBase")
                        .WithMany("SpesimentItemBases")
            ...
            modelBuilder.Entity("API.Entities.Unit", b =>
                {
                    ...
                    b.Navigation("SpesimentItemBases");
